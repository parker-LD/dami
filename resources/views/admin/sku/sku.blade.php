...
@section('content')
    ...
    <div class="mws-panel grid_3" style="height:100%;" id="list" name="aim">
    ...
    <div class="mws-panel grid_5">
        <div class="mws-panel-header">
            <button class="btn btn-success" id="subBut">添加</button>
            <button class="btn btn-danger" id="resBut">清除</button>
        </div>
        <div class="mws-panel-body no-padding">
            <form id="form" class="mws-form" action="/admin/sku/insert" method="post" enctype="multipart/form-data"  target="iFrame">
                <div class="mws-form-inline">
                    <div class="mws-form-row" style="width: 490px;">
                        <label class="mws-form-label">名称</label>
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="title" value="{{old('title')}}">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        <label class="mws-form-label">原价</label>
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="falsePrice" value="{{old('falseprice')}}">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        <label class="mws-form-label">现价</label>
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="price" value="{{old('price')}}">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        <label class="mws-form-label">颜色</label>
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="color" value="{{old('color')}}">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        <label class="mws-form-label">型号</label>
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="attr" value="{{old('attr')}}">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row" style="width: 400px;" >
                        ...
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="stock">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        ...
                        <div class="mws-form-item">
                            ...
                            <input type="radio" title="" name="status" value="0">下架
                        </div>
                    </div>
                ...
                <div class="mws-button-row">
                    ...
                    <button id="sub" class="btn btn-success" title="">保存</button>
