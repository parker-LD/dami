                    ...
                    <div class="uc-box uc-sub-box">
                        <div class="uc-nav-box">
                            ...
                            <div class="box-bd">
                                <ul class="uc-nav-list">
                                    <li>
                                        <a href="//static.mi.com/order/">我的订单</a>
                                    </li>
                                    <li>
                                        <a href="http://service.order.mi.com/insurance/payServiceList?_r=78436.1469842507">手机意外保</a>
                                    </li>
                                    <li>
                                        <a href="//static.mi.com/order/#type=11">团购订单</a>
                                    </li>
                                    <li>
                                        <a href="http://order.mi.com/user/comment?filter=1&r=78436.1469842507" data-count="comment" data-count-style="bracket">评价晒单</a>
                                    </li>
                                    <li>
                                        <a href="http://recharge.10046.mi.com/list">话费充值订单</a>
                                    </li>
                                    <li>
                                        <a href="http://huanxin.mi.com/order/list?r=78436.1469842507">以旧换新订单</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="uc-nav-box">
                            ...
                            <div class="box-bd">
                                <ul class="uc-nav-list">
                                    ...
                                    <li>
                                        <a href="http://order.mi.com/cashAccount?r=78436.1469842507">现金账户</a>
                                    </li>
                                    <li>
                                        <a href="http://order.mi.com/ecard/bind?r=78436.1469842507">小米礼品卡</a>
                                    </li>
                                    <li>
                                        <a href="http://order.mi.com/huanxin/list?r=78436.1469842507">手机换新券</a>
                                    </li>
                                    <li>
                                        <a href="http://order.mi.com/user/favorite?r=78436.1469842507">喜欢的商品</a>
                                    </li>
                                    <li>
                                        <a href="http://order.mi.com/user/coupon?r=78436.1469842507">优惠券</a>
                                    </li>
                                    <li class="active">
                                        <a href="http://order.mi.com/user/address?r=78436.1469842507">收货地址</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="uc-nav-box">
                            ...
                            <div class="box-bd">
                                <ul class="uc-nav-list">
                                    <li>
                                        <a href="http://service.order.mi.com/record/list?_r=78436.1469842507">服务记录</a>
                                    </li>
                                    <li>
                                        <a href="http://service.order.mi.com/apply/fill?_r=78436.1469842507">申请服务</a>
                                    </li>
                                    <li>
                                        <a href="http://service.order.mi.com/user/compensate?_r=78436.1469842507">领取快递报销</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
