...
class OrderController extends Controller
{
    ...
    public function getPayfor(Request $request)
    {
        ...
        {
            $url = 'http://pay.xiaohigh.com/api/deal?to=649342195@qq.com&money='.session('order')['totalPrice'].'&order_id='.session('order')['id'].'&info='.'网站名称'.'&return_url=http://dami.com/order/changeStatus';
            return redirect($url);
        }
    }
